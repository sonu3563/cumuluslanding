  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-lg max-w-5xl w-full p-4">
      ...
      <div className="overflow-y-auto max-h-[70vh] ">
        <table className="table-auto w-full border-collapse border border-gray-200 text-sm z-50">
          <thead>
            <tr>
              ...
              {planNames.map((plan, index) => (
                <th
                  key={index}
                  className="border border-gray-200 p-2 bg-gray-100 text-center"
                >
                  {plan}
                </th>
              ))}
          ...
          <tbody>
            {tableData.map((row, rowIndex) => (
              <tr key={rowIndex}>
                <td className="border border-gray-200 p-2">{row.feature}</td>
                {row.plans.map((plan, planIndex) => (
                  <td
                    key={planIndex}
