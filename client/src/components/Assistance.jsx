...
//     return (
//         <div className="bg-white p-2 sm:p-8 md:p-10 lg:p-16 px-2 sm:px-2 md:px-16 lg:px-32 h-screen">
//             <div className="bg-gray-900 text-white flex flex-col justify-around items-center md:flex-row rounded-xl">
//                 {/* Left Form Section */}
//                 <div className="w-full max-w-lg px-6 py-8 md:w-1/2">
